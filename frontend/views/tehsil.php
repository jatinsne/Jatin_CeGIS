                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Tehsil</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Tehsil</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="stateModalTitle">Tehsil</h5>
                                    ...
                                    <div class="modal-body">
                                        <form id="stateForm" autocomplete="off">
                                            <div class="mb-3">
                                                ...
                                                <input name="name" id="stateNameField" required type="text" class="form-control" placeholder="Enter tehsil name">
                                                <input name="id" id="idField" type="hidden" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">District</label>
                                                <select required class="form-control" name="districtid" id="stateid">
                        ...
                        <a onclick="openStateModal()" class="btn btn-primary text-light m-r-10 m-b-10 mb-3">Add New Tehsil</a>
...
<script src="../assets/js/pages/tehsil.js"></script>
<?php

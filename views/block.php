            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="stateModalTitle">Block</h5>
                                    ...
                                    <div class="modal-body">
                                        <form id="stateForm" autocomplete="off">
                                            <div class="mb-3">
                                                ...
                                                <input name="name" id="stateNameField" required type="text" class="form-control" placeholder="Enter block name">
                                                <input name="id" id="idField" type="hidden" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Tehsil</label>
                                                <select required class="form-control" name="tehsilid" id="talukid">
                        ...
                        <a onclick="openStateModal()" class="btn btn-primary text-light m-r-10 m-b-10 mb-3">Add New Block</a>
...
<script src="../assets/js/pages/block.js"></script>
<?php

    ...
    columnDefs: [
      {
        ...
        render: function (data, type, full, meta) {
          return `<ul class="list-inline mb-0 text-end">
              <li class="list-inline-item"><a onclick=edit(this) data-id="${data}" data-tehsilid="${full.states_id}" data-item="${full.district_name}" class="avtar avtar-s btn-link-success btn-pc-default"><i class="ti ti-edit f-20"></i></a></li>
...
stateForm.addEventListener("submit", (e) => {
  ...
  if (idField.value > 0) {
    const requestOptions = {
      method: "PUT",
      body: `id=${idField.value}&name=${stateNameField.value}&stateid=${stateidField.value}`,
      headers: {
        Accept: "*/*",
    ...
    fetch(BACKENDURL + "district", requestOptions)
